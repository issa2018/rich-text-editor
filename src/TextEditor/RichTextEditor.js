...
function isImage (url) {
  console.log('isImage: ', url.endsWith)
...
class RichTextEditor extends React.Component {
  ...
  onClickImage = event => {
    ...
    if (!src) return
    if (!isUrl(src)) return
    // FIXME: check if the url is of an image
  ...
  renderNode = (props, editor, next) => {
    ...
    switch (node.type) {
      ...
      case 'image': {
        ...
        console.log('Render image node', src)
  ...
  renderMark = (props, editor, next) => {
    ...
    switch (mark.type) {
      ...
      case 'tab':
        console.log('Render marked call for ', mark.type)
        // return <u {...attributes}>{children}</u>
        return next()
      case 'shifttab':
        console.log('Render marked call for ', mark.type)
  ...
  onKeyDown = (event, editor, next) => {
    ...
    if (event.shiftKey && event.key === 'Tab') {
      console.log('Key down event', event.key, event.shiftKey)
    }
